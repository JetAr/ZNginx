...
typedef struct Lib3dsIo
{
    ...
    //z Get current position in stream
...
typedef struct Lib3dsMeshInstanceNode
{
    ...
    float           morph_smooth;
    char            morph[64];
    Lib3dsTrack     pos_track;//z 分别是 position
    Lib3dsTrack     rot_track;//z rotation
    Lib3dsTrack     scl_track;//z scale
    Lib3dsTrack     hide_track;//z ??hide
