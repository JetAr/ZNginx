...
void Font::VerifyRequiredTables() const
{
    ...
    uint32_t required_tables[] =
    {
        ...
        CreateTag('h','m','t','x'),
        CreateTag('m','a','x','p'),
        //CreateTag('n','a','m','e'),		// in theory required, but I don't use it
        //CreateTag('O','S','/','2'),
        //CreateTag('p','o','s','t'),
    };
...
void Font::VerifyTrueTypeTables() const
{
    ...
    uint32_t required_tables[] =
    {
        //CreateTag('c','v','t',' '),					// in theory required, but I don't use it
        //CreateTag('f','p','g','m'),
        CreateTag('g','l','y','f'),
        CreateTag('l','o','c','a'),
        //CreateTag('p','r','e','p'),
...
vec4t Font::GetGlyphRect(uint16_t glyph_index) const
{
    ...
    // done
    return r;
    //return vec4t(r.z, r.w, r.x, r.y);		// reorder coordinates
}
