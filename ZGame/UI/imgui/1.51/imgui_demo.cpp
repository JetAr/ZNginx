/* #CC
       Zey_S : //z 17-08-10 11:23:21 L.143'45399 T147895787 .K.F2595318366-+----+----+----+----+
		//k
       Zey_E : //z 17-08-10 11:23:21 L.143'45399 T147895787 .K---+----+----+----+----+----+----+
       Zcl_S : //z 17-08-10 11:23:21 L.143'45399 T147895787 .K---+----+----+----+----+----+----+
       Zcl_E : //z 17-08-10 11:23:21 L.143'45399 T147895787 .K---+----+----+----+----+----+----+
      KmtIdx : //z 17-08-10 11:35:46 L.143'44654 T149153653 .K ~2   --+----+----+----+----+----+
     Zndex_S : //z 17-08-10 11:23:21 L.143'45399 T147895787 .K---+----+----+----+----+----+----+
      L574 ,   1: 08-10 //k 2017-08-10 11:23 zn#1 加入images
      L2587,   2:TODO: display items starting from the bottom
     Zndex_E : //z 17-08-10 11:35:56 L.143'44644 T149153686 .K ~12  --+----+----+----+----+----+
\* #HE //z 2017-08-10 11:23:21 L.143'45399 BG57IV3 T147895787 .K*******************************/
...
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
		...
		//k 2017-08-10 11:23 zn#1 加入 images 
        if (ImGui::TreeNode("Images"))
        {
            ...
            for (int i = 0; i < 8; i++)
            {
				...
				//k 2017-08-10 11:35 zn#2  image buttons 是否按下
    ...
    if (ImGui::CollapsingHeader("Popups & Modal windows"))
    {
        ...
        if (ImGui::TreeNode("Context menus"))
        {
            ...
            char buf[64];
            sprintf(buf, "Button: %s###Button", name); // ### operator override ID ignoring the preceeding label
            ImGui::Button(buf);
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        ImGui::SameLine();
        ShowHelpMarker("Request ImGui to render a mouse cursor for you in software. Note that a mouse cursor rendered via regular GPU rendering will feel more laggy than hardware cursor, but will be more in sync with your other visuals.");
