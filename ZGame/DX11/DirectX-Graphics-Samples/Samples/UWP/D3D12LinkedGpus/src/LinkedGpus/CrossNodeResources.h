...
public:
    ...
    inline ID3D12CommandQueue* GetCommandQueue(UINT nodeIndex)
    {
        return m_queues[nodeIndex].Get();
    }
    inline IDXGISwapChain3* GetSwapChain()
    {
        return m_swapChain.Get();
    }
    inline ID3D12RootSignature* GetSceneRootSignature()
    {
        return m_sceneRootSignature.Get();
    }
    inline ID3D12PipelineState* GetScenePipelineState()
    {
        return m_scenePipelineState.Get();
    }
    inline ID3D12RootSignature* GetPostRootSignature()
    {
        return m_postRootSignature.Get();
    }
    inline ID3D12PipelineState* GetPostPipelineState()
    {
        return m_postPipelineState.Get();
    }
