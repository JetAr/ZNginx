...
protected:
    ...
    {
        return val > m_MaxValue ? m_MaxValue : val < m_MinValue ? m_MinValue : val;
    }
...
private:
    int32_t Clamp( int32_t val )
    {
        return val < 0 ? 0 : val >= m_EnumLength ? m_EnumLength - 1 : val;
    }
