...
std::wstring Glyph3::TO_STRING_D3D_SHADER_VARIABLE_TYPE( D3D_SHADER_VARIABLE_TYPE vartype )
{
    ...
    case D3D_SVT_BYTEADDRESS_BUFFER:
        s << L"BYTEADDRESS_BUFFER";
        break;
    case D3D_SVT_RWBYTEADDRESS_BUFFER:
        s << L"RWBYTEADDRESS_BUFFER";
        break;
    case D3D_SVT_STRUCTURED_BUFFER:
        s << L"STRUCTURED_BUFFER";
        break;
    case D3D_SVT_RWSTRUCTURED_BUFFER:
        s << L"RWSTRUCTURED_BUFFER";
        break;
    case D3D_SVT_APPEND_STRUCTURED_BUFFER:
        s << L"APPEND_STRUCTURED_BUFFER";
        break;
    case D3D_SVT_CONSUME_STRUCTURED_BUFFER:
        s << L"CONSUME_STRUCTURED_BUFFER";
        break;
    }
...
std::wstring Glyph3::TO_STRING_D3D_SHADER_INPUT_TYPE( D3D_SHADER_INPUT_TYPE type )
{
    ...
    case D3D_SIT_UAV_RWSTRUCTURED:
        s << L"UAV_RW_STRUCTURED";
        break;
    case D3D_SIT_BYTEADDRESS:
        s << L"UAV_BYTE_ADDRESS";
        break;
    case D3D_SIT_UAV_RWBYTEADDRESS:
        s << L"UAV_RW_BYTE_ADDRESS";
        break;
    case D3D_SIT_UAV_APPEND_STRUCTURED:
        s << L"UAV_APPEND_STRUCTURED";
        break;
    case D3D_SIT_UAV_CONSUME_STRUCTURED:
        s << L"UAV_CONSUME_STRUCTURED";
        break;
    case D3D_SIT_UAV_RWSTRUCTURED_WITH_COUNTER:
        s << L"UAV_RWSTRUCTURED_WITH_COUNTER";
        break;
    }
...
std::wstring Glyph3::TO_STRING_D3D_CBUFFER_TYPE( D3D_CBUFFER_TYPE type )
{
    ...
    case D3D_CT_INTERFACE_POINTERS:
        s << L"INTERFACE_POINTERS";
        break;
    case D3D_CT_RESOURCE_BIND_INFO:
        s << L"RESOURCE_BIND_INFO";
        break;
    }
...
std::wstring Glyph3::TO_STRING_D3D_NAME( D3D_NAME name )
{
    ...
    case D3D_NAME_RENDER_TARGET_ARRAY_INDEX:
        s << L"RENDER_TARGET_ARRAY_INDEX";
        break;
    case D3D_NAME_VIEWPORT_ARRAY_INDEX:
        s << L"VIEWPORT_ARRAY_INDEX";
        break;
    ...
    case D3D_NAME_DEPTH_GREATER_EQUAL:
        s << L"DEPTH_GREATER_EQUAL";
        break;
    case D3D_NAME_DEPTH_LESS_EQUAL:
        s << L"DEPTH_LESS_EQUAL";
        break;
    }
...
std::wstring Glyph3::TO_STRING_D3D_TESSELLATOR_OUTPUT_PRIMITIVE( D3D_TESSELLATOR_OUTPUT_PRIMITIVE primitive )
{
    ...
    case D3D_TESSELLATOR_OUTPUT_TRIANGLE_CW:
        s << L"TRIANGLE CLOCKWISE";
        break;
    case D3D_TESSELLATOR_OUTPUT_TRIANGLE_CCW:
        s << L"TRIANGLE COUNTER CLOCKWISE";
        break;
    }
...
std::wstring Glyph3::TO_STRING_D3D_PRIMITIVE_TOPOLOGY( D3D_PRIMITIVE_TOPOLOGY topology )
{
    ...
    case D3D_PRIMITIVE_TOPOLOGY_LINELIST_ADJ:
        s << L"LINE LIST w/ADJACENCY";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_LINESTRIP_ADJ:
        s << L"LINE STRIP w/ADJACENCY";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST_ADJ:
        s << L"TRIANGLE LIST w/ADJACENCY";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP_ADJ:
        s << L"TRIANGLE STRIP w/ADJACENCY";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_1_CONTROL_POINT_PATCHLIST:
        s << L"1 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_2_CONTROL_POINT_PATCHLIST:
        s << L"2 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_3_CONTROL_POINT_PATCHLIST:
        s << L"3 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_4_CONTROL_POINT_PATCHLIST:
        s << L"4 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_5_CONTROL_POINT_PATCHLIST:
        s << L"5 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_6_CONTROL_POINT_PATCHLIST:
        s << L"6 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_7_CONTROL_POINT_PATCHLIST:
        s << L"7 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_8_CONTROL_POINT_PATCHLIST:
        s << L"9 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_10_CONTROL_POINT_PATCHLIST:
        s << L"10 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_11_CONTROL_POINT_PATCHLIST:
        s << L"11 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_12_CONTROL_POINT_PATCHLIST:
        s << L"12 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_13_CONTROL_POINT_PATCHLIST:
        s << L"13 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_14_CONTROL_POINT_PATCHLIST:
        s << L"14 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_15_CONTROL_POINT_PATCHLIST:
        s << L"15 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_16_CONTROL_POINT_PATCHLIST:
        s << L"16 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_17_CONTROL_POINT_PATCHLIST:
        s << L"17 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_18_CONTROL_POINT_PATCHLIST:
        s << L"18 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_19_CONTROL_POINT_PATCHLIST:
        s << L"19 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_20_CONTROL_POINT_PATCHLIST:
        s << L"20 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_21_CONTROL_POINT_PATCHLIST:
        s << L"21 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_22_CONTROL_POINT_PATCHLIST:
        s << L"22 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_23_CONTROL_POINT_PATCHLIST:
        s << L"23 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_24_CONTROL_POINT_PATCHLIST:
        s << L"24 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_25_CONTROL_POINT_PATCHLIST:
        s << L"25 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_26_CONTROL_POINT_PATCHLIST:
        s << L"26 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_27_CONTROL_POINT_PATCHLIST:
        s << L"27 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_28_CONTROL_POINT_PATCHLIST:
        s << L"28 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_29_CONTROL_POINT_PATCHLIST:
        s << L"29 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_30_CONTROL_POINT_PATCHLIST:
        s << L"30 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_31_CONTROL_POINT_PATCHLIST:
        s << L"31 CONTROL POINT PATCHLIST";
        break;
    case D3D_PRIMITIVE_TOPOLOGY_32_CONTROL_POINT_PATCHLIST:
        s << L"32 CONTROL POINT PATCHLIST";
        break;
    }
