...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
    ...
    int GetPartySize()
    {
        return (int)m_vParty.size();
    }
    CPlayer *GetPartyMember(int index)
    {
        return m_vParty[index];
    }

    // This adds a player to our current part
    void AddPlayerToParty(CPlayer *pPlayer)
    {
        m_vParty.push_back(pPlayer);
    }
...
// *Quick Notes*
//
// In this version we added a bunch of functions to handle our party
// and attacking code.
//
//
