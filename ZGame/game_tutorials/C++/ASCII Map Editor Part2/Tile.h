...
// These defines hold our info file paths for tile types.  We will read these in one
// at a time and then extract the information from them for each specific tile.
...
// *Quick Notes*
//
// We added to this file 3 new defines for the text files that store
// the tile information for monsters, items and npcs.  We also added
// 4 new functions to our CMap class, which allow us to insert and
// delete tiles from the map, along with a function to display the
// tile's name.  The last function loads the text files which store
