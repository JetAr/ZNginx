...
public:
    ...
    {
        return m_bLeftMousePressed;
    }
    bool IsRightMousePressed()
    {
        return m_bRightMousePressed;
    }
    bool IsMouseEvent()
    {
        return (m_inputRecord.EventType == MOUSE_EVENT);
    }
    bool IsKeyboardEvent()
    {
        return (m_inputRecord.EventType == KEY_EVENT);
    }
    WORD GetKeyCode()
    {
...
// also an extern to the global g_SaveLoad object.
//
//
