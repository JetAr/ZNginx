...
// *Quick Notes*
//
// We added a bunch of constants for equipping items to the player,
// as well as many functions in the CPlayer class that enable us to
// control and work with the inventory of the player.
//
//
