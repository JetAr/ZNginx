...
/*
	The purpose of this program is demonstrate how pointers are used.  This program
	consists of one function that swaps the values of two integers passed into it.
...
void SwapCorrect(int *num1, int *num2)
{
    ...
    // Therefore, first we'll make a temporary number to store num1.
    // What does the * do???
    // If we were to cout num1 you would see it's a long crazy looking number.

    // Try it -- by removing the comment from this cout
    ...
    // we want what is stored at that address in memory.  This is what the * accomplishes.
    // The * gets us what is stored at that address in memory.
    int temp = *num1;
