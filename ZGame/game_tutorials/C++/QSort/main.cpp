...
const int kMaxNum = 15; // Max number of elements in the array
...
int main()
{
    ...
    int numArray[kMaxNum] = {0}; // Zero it out for starters

    for(int i = 0; i < kMaxNum; i++)
        numArray[i] = rand()%200; // Make some random integers

    PrintArray(numArray,kMaxNum);
    ...
    // kMaxNum -- This is the number of elements in the array
    ...
    //			  data.  The declaration for this function looks like this:
    //			  int (__cdecl *Compare )(const void *elem1, const void *elem2)
    //			  Which, as you can see is pretty ugly and scary :)
    qsort(numArray,kMaxNum,sizeof(int),Compare); // Sort the array

    PrintArray(numArray,kMaxNum); // Reprint the array
    return 0;
}

// Print the array -- "num" is how many numbers are in the array
...
/*
	...
	A: No -- Name it whatever you want.

	Q: Do I really have to declare my function using const void* ???
	   I mean if I know I'm passing in integers can I do this:
	   int compare(const int *e1, const int *e2); ?
	A: Nope.  C++ says do it this way or watch your computer melt.
