...
public:
    ...
    void SetChar(CHAR_INFO charNew)
    {
        m_charTile = charNew;
    }
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
    ...
    bool m_bSolid;					// This tells us if we should collide with this character
...
public:
    ...
    CHAR_INFO GetEditorSelection(int x, int y)
    {
        return m_screenBuffer[x + y * MAP_WIDTH];
    }
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
    ...
    // This sets a normal tile on the map to either solid or not solid
    void SetCollisionTile(bool bIsSolid, int x, int y);

    // This returns a tile on the map according to the position (any type of tile)
    CTile *FindMapTile(int mapX, int mapY);
...
// *Quick Notes*
//
// We added 2 functions to our CMap class:
//
// SetCollisionTile() and FindMapTile()
//
// These function set a normal tile to collidable or not, as well as
// return a type of tile from the map's tile list that has the position
// passed in.
//
// We added 2 variables to our CTile class, m_bSolid and m_actionKey.
// This stores the collision and trigger information.
//
//
