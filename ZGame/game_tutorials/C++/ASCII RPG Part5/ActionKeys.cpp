...
// We only add 1 line of code to this file, which calls the shop code
// when the player talks to a shop keeper.  This is done using the
// 555 action key code, defined as kShopKeeperKey.
//
//
...
// *Quick Notes*
//
// There was 1 line of code added to this file in HandleKeys(),
// which starts up the shop and brings us to the shop menu when
// the kShopKeeperKey key is passed in (555).  This number was
// chosen out of no specific preference.  We used this number
// when we created the shop keeper npcs on the maps.  You have
// to make sure that this number is the same in the game as it
// in on the created map.
//
//
