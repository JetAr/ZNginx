...
// *Quick Notes*
//
// This file holds all of our main tile and map classes and definitions.
// Since we are using many different tile types we can create a base class
// and use inheritance to cut down on our code and increase readability.
// We created a CTile class for the normal tiles, then have our other tiles
// like items, monsters, etc... inherit from the base CTile class.  That way
// we can pass in any type of tile into many of our functions by using
// CTile *pTile as a parameter.
//
// If you are unfamiliar with inheritance, please
