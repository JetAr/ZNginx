...
// drivel, lets get coding.

#include <windows.h> // We include this header file so we can call the function GetTickCount()
#include <iostream>  // Here we include "iostream" so we can use "cout"
using namespace std; // We want the STanDard functionality of "iostream"
...
int main()
{
    ...
    cout << "A call to rand() gave us: " << num1 << endl; // We'll print the int to the screen

    // So the next question is:  Okay that's great, I get a random int.  Now what if I want it
    // say between 0 - 10?  How do I do that?  Well here is where we introduce a VERY HANDY math
    ...
    // 39 % 6 = 3		So lets see what is 39 / 6 -- Well 6 goes into 39 six times giving
    ...
    // technically randomly generated, it's just that they use the SAME
    // algorithm each time they are created).
