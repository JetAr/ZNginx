...
bool SoftShadowShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
    ...
    result = InitializeShader(device, hwnd, L"../Engine/softshadowvs.hlsl", L"../Engine/softshadowps.hlsl");
    if (!result)
    {
        return false;
    }
...
bool SoftShadowShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
    ...
    result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "SoftShadowVertexShader", "vs_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
    ...
    result = D3DX11CompileFromFile(psFilename, NULL, NULL, "SoftShadowPixelShader", "ps_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
