...
bool GlowShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
    ...
    result = InitializeShader(device, hwnd, L"../Engine/glowvs.hlsl", L"../Engine/glowps.hlsl");
    if (!result)
    {
        return false;
    }
...
bool GlowShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
    ...
    result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "GlowVertexShader", "vs_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
    ...
    result = D3DX11CompileFromFile(psFilename, NULL, NULL, "GlowPixelShader", "ps_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
