...
bool WaterShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
    ...
    result = InitializeShader(device, hwnd, L"../Engine/watervs.hlsl", L"../Engine/waterps.hlsl");
    if (!result)
    {
        return false;
    }
...
bool WaterShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
    ...
    result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "WaterVertexShader", "vs_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
    ...
    result = D3DX11CompileFromFile(psFilename, NULL, NULL, "WaterPixelShader", "ps_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
