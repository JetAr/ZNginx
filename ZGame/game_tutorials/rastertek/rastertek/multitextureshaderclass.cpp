...
bool MultiTextureShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
    ...
    result = InitializeShader(device, hwnd, L"../Engine/multitexturevs.hlsl", L"../Engine/multitextureps.hlsl");
    if (!result)
    {
        return false;
    }
...
bool MultiTextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
    ...
    result = D3DX11CompileFromFile(vsFilename, NULL, NULL, "MultiTextureVertexShader", "vs_4_0",
    ...
    result = D3DX11CompileFromFile(psFilename, NULL, NULL, "MultiTexturePixelShader", "ps_4_0",
...
bool MultiTextureShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix,
