...
bool VerticalBlurShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix,
...
void VerticalBlurShaderClass::RenderShader(ID3D11DeviceContext* deivceContext, int indexCount)
{
