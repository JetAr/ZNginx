...
void CPlayer::Draw()
{
    ...
    // We decided to just leave the tile coordinates with our tiles so we
    // can keep it simple for this type of game, but if you want to create
    // animations and have the player move smoothly along the map and such,
    // you will want to changed this.
