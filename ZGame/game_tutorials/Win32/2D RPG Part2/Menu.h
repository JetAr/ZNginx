...
public:
    ...
    // Notice that we have a set, but not a get function for our function
    // pointer.  This is because it's pointless to have a get function
    // since we can just call the function.  We could do something tricky
    // and make a typedef to allow syntax for such a thing, but not necessary.
...
public:
    ...
    void SetSelectedItem(CItem *pItem)
    {
        m_pItem = pItem;
    }
...
// *Quick Notes*
//
// We added the class definitions for our CButton and CMenu classes.
// We also have many definitions for dialog positions and constants.
//
//
