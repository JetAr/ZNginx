...
const int kMapStatsX     = 10;
const int kMapStatsY     = 400;

// This is the radius for a monster to detect and pursue a player
const int kMonsterRange  = 2;
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
    ...
    // Here are our save and load functions for saving and loading the item
    void SaveItem(FILE *fp);
    void LoadItem(FILE *fp);
...
class CPlayer;						// Let the CMonster object know about CPlayer
...
public:
    ...
    // This turns the stats bar on and off from the map (Put a pause between each toggle)
    void ToggleStatsFlag()
    {
    ...
    // This deletes items from the map that were already taken
    void DeleteTakenItems();
...
// *Quick Notes*
//
// We added save and load functions to the CItem class.
//
//
