...
#include "SaveLoad.h"						// Include the save and load class

extern CSaveLoad g_SaveLoad;				// Make the save load object global

extern OPENFILENAME g_OpenInfo;				// This holds our dialog box info for saving/loading
...
// Make the global shop object available
extern CShop g_Shop;
...
public:
    ...
    int IsLeftMousePressed()
    {
        return GetAsyncKeyState(VK_LBUTTON) & 0x8000;
    }
    int IsRightMousePressed()
    {
...
// *Quick Notes*
//
// We added the header file for our save and load class/data, and
// also an extern to the global g_SaveLoad object.  We also added
// global data for using window's open and save dialog boxes.
//
//
