...
// *Quick Notes*
//
// We added 2 new functions in CMap that deal with checking for and item
// and toggling the stats bar on and off.  Other than that there was some
// stats bar coordinates that were added at the top of this file.
//
//
