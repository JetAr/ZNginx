...
public:
    ...
    void setLeftMB(bool onOrOff)
    {
        mKeys[VK_LBUTTON] = onOrOff;
    }
    void setRightMB(bool onOrOff)
    {
        mKeys[VK_RBUTTON] = onOrOff;
    }
    void setMiddleMB(bool onOrOff)
    {
        mKeys[VK_MBUTTON] = onOrOff;
    }
