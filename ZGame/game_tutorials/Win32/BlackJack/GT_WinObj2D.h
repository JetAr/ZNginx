...
public:
    ...
    HDC getBackDC()
    {
        return mBackBuff.getDC();    // Get back buffer HDC
    }
    float getDT()
    {
        return mDeltaTime;    // Get time slice for current frame
    }
    int getFPS()
    {
        return mFPS;    // Get current frames per second
    }
    ...
    bool isLeftMBDown()
    {
        return mInput.isLeftMBDown();
    }
    bool isRightMBDown()
    {
        return mInput.isRightMBDown();
    }
    bool isMiddleMBDown()
    {
        return mInput.isMiddleMBDown();
    }
...
private: // -- Private methods --
    ...
    CWinObj2D& operator =(const CWinObj2D &obj)
    {
        return *this;
    }
};
