...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
    ...
    // This returns a pointer to a tile from the map at mapX and mapY
    CTile *GetTile(int mapX, int mapY);
...
// *Quick Notes*
//
// In order to add action key and collision functionality we added
// 2 variables to our CTile class, along with set and get functions.
// Lastly, we added the GetTile() function to our CMap class, which
// returns a pointer to a tile under the cursor when the user clicks
