...
//
// In this tutorial we added a Camera object to our class so we can get access
// to the camera's perspective and view matrices.  We removed the setter functions
// for those matrices.
//
//
