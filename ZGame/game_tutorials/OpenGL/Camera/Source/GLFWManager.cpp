...
// We added to this class a way to initialize a camera and pass it to our main
// application and InputManager.  We then check for the standard movement keys
// like the arrow keys and W,A,S,D to move the camera arrow.  We only show how
// to initially move the camera back and forth, but we added the left and right
// keys for the next tutorial which shows how to rotate from left to right, and
// later to strafe for a future tutorial.
//
//
