...
void SizeOpenGLScreen(int width, int height)			// Initialize The GL Window
{
    ...
    gluPerspective(45.0f, (GLfloat)width / (GLfloat)height, 1, 2000.0f);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprev, PSTR cmdline, int ishow)
{
    ...
    hWnd = CreateMyWindow("www.GameTutorials.com - GTF Loader Part 2", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
