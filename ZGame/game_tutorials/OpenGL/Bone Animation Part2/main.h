...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
    ...
    // Since our exporter handles the ability to have multiple textures
    // per mesh we need to store a material size with each object now.
...
bool CreateTexture(LPSTR strFileName, UINT &texture);
...
// * QUICK NOTES *
//
// We just added a numOfMaterials to the t3DObject structure so that each
// object can have multiple textures applied to it's faces.
//
//
