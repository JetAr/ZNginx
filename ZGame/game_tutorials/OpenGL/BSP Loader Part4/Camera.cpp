...
// In this file we add an extern for our level object so that we can call
// the collision detection routine for checking collision against our camera
// with a given Radius.  We will change a lot more things when we get into
// the next 2 tutorials that deal with sliding, gravity and climbing stairs/slopes.
// We also took our the restrictions for the camera looking up and down.  Otherwise
// the collision detection screws up the camera when sliding.  If you want a better
// camera class, it would be wise to use quaternions which can do excellent rotations.
...
/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
    ...
    // We took our the camera restrictions for looking up and down
...
// * QUICK NOTES *
//
// In this file we added an external variable for the level, so that we could
// called the trace function in order to check for collision.  We also got rid
// of the camera restrictions for looking up and down.
//
//
