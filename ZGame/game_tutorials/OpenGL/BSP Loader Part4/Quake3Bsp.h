...
enum eLumps
{
    ...
    kIndices,					// Stores the levek indices
...
// * QUICK NOTES *
//
// In this file we added some new structures, variables and functions for our
// BSP class.  We also added a constant and some defines for the type of
// collision detection we are doing (ray, sphere, etc...).
//
//
