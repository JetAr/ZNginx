...
// We just add a little code to do AABB collision and make sure the view vector
// doesn't eclipse the camera position when we collide backwards into a wall.
//
//
...
// * QUICK NOTES *
//
// We added some code in our CheckForMovement() function to not allow the view
// vector to eclipse the camera position when colliding backwards into a wall.
//
//
