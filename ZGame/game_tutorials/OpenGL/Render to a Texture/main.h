...
// We only need 2 texture for the rendered texture and the cube's texture map
...
bool CreateTexture(UINT &textureArray, LPSTR strFileName);
...
// * QUICK NOTES *
//
// Nothing new was added to this file except we changed the MAX_TEXTURES to 2
// and made out screen width 640 by 480.
//
//
