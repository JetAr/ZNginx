...
void DeInit()
{
    if (g_hRC)
    {
        glDeleteTextures(MAX_TEXTURES, g_Texture);		// Free the textures
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprev, PSTR cmdline, int ishow)
{
    ...
    hWnd = CreateMyWindow("www.GameTutorials.com - Rendering To A Texture",
                          SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
