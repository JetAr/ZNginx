...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprev, PSTR cmdline, int ishow)
{
    ...
    hWnd = CreateMyWindow("www.GameTutorials.com - Transparency", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
// * QUICK NOTES *
//
// Nothing new in this file, just the initialization stuff.  Below are the notes
// in main.cpp.
//
