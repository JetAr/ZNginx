...
bool CreateTexture(LPTSTR szFileName, GLuint &textureID)                            // Creates Texture From A Bitmap File
{
...
// * QUICK NOTES *
//
// This tutorial shows how to load a .3ds file and animate using key frames.
// Nothing regarding this tutorial was added to this file from the last tutorial,
// except we now do backface culling in InitializeOpenGL() for optimization.
// It is the standard file for initialization and texture maps.
//
//
//
