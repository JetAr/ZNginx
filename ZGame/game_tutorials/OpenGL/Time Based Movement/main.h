...
// * QUICK NOTES *
//
// In this tutorial we use GetTickCount().  However, GetTickCount() doesn't seem to
// update as fast as timeGetTime(), found in <mmsystem.h>.  So if your a micro second
// bean counter you may want to try out timeGetTime() instead of GetTickCount().
//
