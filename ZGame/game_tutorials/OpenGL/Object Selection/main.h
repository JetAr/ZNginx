...
#define MAX_TEXTURES 3									// This says how many texture we will be using
...
// * QUICK NOTES *
//
// Nothing new was added to this file for this tutorial (Since the quadratic tutorial)
// Although, we did change the MAX_TEXTURES to allow more textures for this tutorial
//
//
