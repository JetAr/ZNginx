...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprev, PSTR cmdline, int ishow)
{
    ...
    hWnd = CreateMyWindow("www.GameTutorials.com - Quadrics", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
// * QUICK NOTES *
//
// All we added in this tutorial for this file is the depth testing.  When ever
// we have more than one polygon in our program, we want them to draw in the correct
// order, otherwise they will draw over each other sometimes, no matter what distance.
//
//
//
// DigiBen
