...
void SizeOpenGLScreen(int width, int height)			// Initialize The GL Window
{
    ...
    gluPerspective(45.0f,(GLfloat)width/(GLfloat)height, .5f ,850.0f);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprev, PSTR cmdline, int ishow)
{
    ...
    hWnd = CreateMyWindow("www.GameTutorials.com - 3DS Loader", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
// * QUICK NOTES *
//
// This tutorial shows how to load a .3ds file.  Nothing regarding this tutorial
