...
bool bSetupPixelFormat(HDC hdc)
{
    ...
    pfd.cStencilBits = 128;								// We desire no stencil bits
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprev, PSTR cmdline, int ishow)
{
    ...
    hWnd = CreateMyWindow("www.GameTutorials.com - GLSL Shadow Mapping with PCF", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
// * QUICK NOTES *
//
// Nothing was added new to this file for this tutorial.
//
//
