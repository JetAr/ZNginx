...
//
// In this tutorial we added the new MouseMoved() function which takes the mouse
// x and y deltas from the last frame.  We also removed the LEFT/RIGHT options
// in KeyPressed() since the mouse now controls the view rotations.
//
