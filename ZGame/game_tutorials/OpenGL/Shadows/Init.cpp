...
bool bSetupPixelFormat(HDC hdc)
{
    ...
    pfd.cAccumBits = 0;									// No special bit planes needed


/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *

    pfd.cStencilBits = 1;								// We add a stencil bit for shadows
...
//////////////////////////// SIZE OPENGL SCREEN \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
/////
/////	This function resizes the view port for OpenGL.
/////
//////////////////////////// SIZE OPENGL SCREEN \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*
...
void InitializeOpenGL(int width, int height)
{
    ...
    SizeOpenGLScreen(width, height);					// Setup the screen translations and view port
}
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hprev, PSTR cmdline, int ishow)
{
    ...
    hWnd = CreateMyWindow("www.GameTutorials.com - Shadows", SCREEN_WIDTH, SCREEN_HEIGHT, 0, g_bFullScreen, hInstance);
...
// * QUICK NOTES *
//
// Nothing was added to this file from previous tutorials other than the adding
// a stencil bit to our pixel-format descriptor:
//
// pfd.cStencilBits = 1;
//
//
