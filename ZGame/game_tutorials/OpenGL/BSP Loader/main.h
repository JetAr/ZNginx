...
// * QUICK NOTES *
//
// We added a new CVector2 class that acts just like is elder brother, CVector3.
// In this version, we also changed the screen width and height to 640 x 480
// to suck up as much frames per second as possible without looking bad.
//
//
