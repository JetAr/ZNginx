...
/*
	The cross product is the core linear algebra operation that is needed to
	compute a normal.  The cross product takes two vectors and returns a
	vector that is orthogonal to the plane which contains the original two vectors.
	This of course is the definition of a normal.
*/
