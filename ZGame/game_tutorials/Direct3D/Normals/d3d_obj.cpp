...
bool CD3DObj::renderLine(SVertex *vertList, int numVerts)
{
    ...
    // By parameter:
    // D3DPT_LINELIST -- The type of primitive (line segments) to render
...
bool CD3DObj::clear(int color, float zDepth)
{
    ...
    // D3DCLEAR_TARGET|D3DCLEAR_ZBUFFER -- This is flag that says what exactly we're clearing
    //									   in the viewport it can be a combination of these
    //									   three flags:
    ...
    // zDepth -- The value to clear the depth buffer to
