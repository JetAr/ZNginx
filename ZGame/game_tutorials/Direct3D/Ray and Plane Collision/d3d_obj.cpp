...
bool CD3DObj::render(const SVertex *vertList, int numVerts)
{
...
bool CD3DObj::render(const SVertex *vertList, int numVerts, const WORD *indexList, int numIndices)
{
...
bool CD3DObj::renderLine(const SVertex *vertList, int numVerts)
{
