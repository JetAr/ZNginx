...
const char kShaderFile[] = "Shader.fx";
...
bool CD3DObj::init(HWND hwnd)
{
    ...
    mResult = D3DXCreateEffectFromFile(mDevice, kShaderFile,	NULL, NULL,	0,
...
bool CD3DObj::initForDebug(HWND hwnd)
{
    ...
    // Load the effect file so that it is capable of debugging while checking for errors
    mResult = D3DXCreateEffectFromFile(mDevice, kShaderFile, NULL, NULL, compilerOpts, NULL,
                                       &mEffect, &errorBuffer);
