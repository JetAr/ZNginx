...
public:
    ...
    // Sets the fill mode to either:  D3DFILL_POINT, D3DFILL_WIREFRAME, or D3DFILL_SOLID
    // Returns true on success, false otherwise
    static bool setFillMode(D3DFILLMODE fillMode);

    // Either turns on or off alpha blending
    // Returns true on success, false otherwise
    static bool setAlphaBlendMode(bool onOrOff);
...
private:
    ...
    static void setPresentationParams(D3DPRESENT_PARAMETERS &params); // Set D3DPRESENT_PARAMETERS
