...
public:
    ...
    void setAlpha( ALPHABLENDING Alpha )
    {
        AlphaBlend = Alpha;
    };
    ALPHABLENDING getAlpha()
    {
        return AlphaBlend;
    };
    void setColor( rgba new_clr )
    {
        clr = new_clr;
    };
    void setColor( rgb new_clr )
    {
        clr = new_clr;
    };
    void setRotate( bool bRot_val )
    {
        bRotate = bRot_val;
    };
    bool getRotate()
    ...
    float getWidth()
    {
        return frames[cur_frame].width;
    };
    float getHeight()
    {
        return frames[cur_frame].height;
    };
...
public:
    ...
    void setPosition( CVector2D new_pos )
    {
        pos = new_pos;
    };
    void setRotationSpeed( float new_rot_speed )
    {
...
public:
    ...
    void Render( RENDERER device );
    void Rotate( CVector new_angle )
    {
        rot_angle = new_angle;
    };
    void setPosition( CVector new_pos )
    {
        pos = new_pos;
    };
    void setRotationSpeed( CVector new_rot_speed )
    {
        rot_speed = new_rot_speed;
    };
