...
public:
    ...
    bool isShowGraphOn()const
    {
        return m_bShowGraph;
    }

    void ToggleShowTiles()
    {
    ...
    bool isShowTilesOn()const
    {
        return m_bShowTiles;
    }

    void ChangeBrush(const brush_type NewBrush)
    {
        m_CurrentTerrainBrush = NewBrush;
    }

    void ChangeSource(const int cell)
    {
        m_iSourceCell = cell;
    }
    void ChangeTarget(const int cell)
    {
        m_iTargetCell = cell;
    }
