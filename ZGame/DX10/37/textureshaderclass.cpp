...
void TextureShaderClass::Render(ID3D10Device* device, int vertexCount, int instanceCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
...
bool TextureShaderClass::InitializeShader(ID3D10Device* device, HWND hwnd, WCHAR* filename)
{
    ...
    // This setup needs to match the VertexType and InstanceType stuctures in the ModelClass and the VertexInputType in the shader.
