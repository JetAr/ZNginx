...
public:
    ...
    void Render(ID3D10Device*, int, D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, ID3D10ShaderResourceView*,
                ID3D10ShaderResourceView*, D3DXVECTOR3, D3DXVECTOR4, D3DXVECTOR4, D3DXMATRIX, D3DXMATRIX, ID3D10ShaderResourceView*, D3DXVECTOR3,
                D3DXVECTOR4);
...
private:
    ...
    void SetShaderParameters(D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, ID3D10ShaderResourceView*, ID3D10ShaderResourceView*,
                             D3DXVECTOR3, D3DXVECTOR4, D3DXVECTOR4, D3DXMATRIX, D3DXMATRIX, ID3D10ShaderResourceView*, D3DXVECTOR3, D3DXVECTOR4);
...
private:
    ...
    ID3D10EffectMatrixVariable* m_lightViewMatrixPtr2;
    ID3D10EffectMatrixVariable* m_lightProjectionMatrixPtr2;
    ID3D10EffectShaderResourceVariable* m_depthMapTexturePtr2;
    ID3D10EffectVectorVariable* m_lightPositionPtr2;
    ID3D10EffectVectorVariable* m_diffuseColorPtr2;
};
