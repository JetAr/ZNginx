...
bool GraphicsClass::Render()
{
    ...
    m_TextureShader->Render(m_D3D->GetDevice(), m_FloorModel->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
    ...
    m_BillboardModel->Render(m_D3D->GetDevice());

    // Render the model using the texture shader.
    m_TextureShader->Render(m_D3D->GetDevice(), m_BillboardModel->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
