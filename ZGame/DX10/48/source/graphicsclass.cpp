...
bool GraphicsClass::RenderSceneToTexture()
{
    ...
    m_DepthShader->Render(m_D3D->GetDevice(), m_CubeModel->GetIndexCount(), worldMatrix, lightViewMatrix, lightOrthoMatrix);
    ...
    m_DepthShader->Render(m_D3D->GetDevice(), m_SphereModel->GetIndexCount(), worldMatrix, lightViewMatrix, lightOrthoMatrix);
...
bool GraphicsClass::Render()
{
    ...
    m_ShadowShader->Render(m_D3D->GetDevice(), m_CubeModel->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
                           lightViewMatrix, lightOrthoMatrix, m_CubeModel->GetTexture(), m_RenderTexture->GetShaderResourceView(),
    ...
    m_ShadowShader->Render(m_D3D->GetDevice(), m_SphereModel->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
                           lightViewMatrix, lightOrthoMatrix, m_SphereModel->GetTexture(), m_RenderTexture->GetShaderResourceView(),
                           m_Light->GetDirection(), m_Light->GetAmbientColor(), m_Light->GetDiffuseColor());
    ...
    m_ShadowShader->Render(m_D3D->GetDevice(), m_GroundModel->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
                           lightViewMatrix, lightOrthoMatrix, m_GroundModel->GetTexture(), m_RenderTexture->GetShaderResourceView(),
                           m_Light->GetDirection(), m_Light->GetAmbientColor(), m_Light->GetDiffuseColor());
