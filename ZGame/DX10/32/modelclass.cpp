...
bool ModelClass::Initialize(ID3D10Device* device, char* modelFilename, WCHAR* colorTextureFilename, WCHAR* normalTextureFilename)
{
    bool result;
...
bool ModelClass::LoadTextures(ID3D10Device* device, WCHAR* colorTextureFilename, WCHAR* normalTextureFilename)
{
    bool result;
