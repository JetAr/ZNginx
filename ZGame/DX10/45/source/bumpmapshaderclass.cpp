...
void BumpMapShaderClass::Render(ID3D10Device* device, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D10ShaderResourceView* colorTexture,
                                ID3D10ShaderResourceView* normalMapTexture, D3DXVECTOR3 lightDirection, D3DXVECTOR4 diffuseColor)
{
    // Set the shader parameters that it will use for rendering.
    SetShaderParameters(worldMatrix, viewMatrix, projectionMatrix, colorTexture, normalMapTexture, lightDirection, diffuseColor);
...
bool BumpMapShaderClass::InitializeShader(ID3D10Device* device, HWND hwnd, WCHAR* filename)
{
    ...
    m_normalMapTexturePtr = m_effect->GetVariableByName("normalMapTexture")->AsShaderResource();
...
void BumpMapShaderClass::SetShaderParameters(D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, ID3D10ShaderResourceView* colorTexture, ID3D10ShaderResourceView* normalMapTexture,
        D3DXVECTOR3 lightDirection, D3DXVECTOR4 diffuseColor)
{
    ...
    m_normalMapTexturePtr->SetResource(normalMapTexture);
