...
bool GraphicsClass::Render(float rotation)
{
    ...
    m_ShaderManager->RenderTextureShader(m_D3D->GetDevice(), m_Model1->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
                                         m_Model1->GetTexture());
    ...
    m_ShaderManager->RenderLightShader(m_D3D->GetDevice(), m_Model2->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
    ...
    m_Model3->Render(m_D3D->GetDevice());
    m_ShaderManager->RenderBumpMapShader(m_D3D->GetDevice(), m_Model3->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix,
