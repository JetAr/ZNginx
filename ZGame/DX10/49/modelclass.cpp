...
bool ModelClass::Initialize(ID3D10Device* device, char* modelFilename, WCHAR* textureFilename, float scale)
{
    bool result;
...
bool ModelClass::InitializeBuffers(ID3D10Device* device, float scale)
{
    VertexType* vertices;
