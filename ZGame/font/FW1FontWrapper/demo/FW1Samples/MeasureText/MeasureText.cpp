...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    const WCHAR str[] = L"中\t\"My Text Layout String\"\n\n123 !!!\n~~\n__ test";
    ...
    while(loop)
    {
        ...
        else
        {
            ...
            const WCHAR *str2 = L"!!! Test \n\tstring\t!\n}{!";

            FW1_RECTF sizeRect = pFontWrapper->MeasureString(str2, L"Arial", 64.0f, &layoutRect, FW1_NOWORDWRAP);

            rectDrawer->drawRect(pImmediateContext, sizeRect.Left, sizeRect.Top, sizeRect.Right, sizeRect.Bottom, 0xffff9977);

            pFontWrapper->DrawString(pImmediateContext, str2, L"Arial", 64.0f, &layoutRect, 0xffffffff, NULL, NULL, FW1_NOWORDWRAP);
