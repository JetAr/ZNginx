...
#define ERROR_INVALID_STATE     POP3_BAD_RESPONSE " Command not valid in this state\r\n"
    ...
    PDWORD      OutputBufferLen)
{
    ...
    {
        *OutputBuffer = ERROR_INVALID_STATE;
        *OutputBufferLen = sizeof(ERROR_INVALID_STATE);
