...
#region 04-27 11:28 R#.0    @Ver.Info
     ...
     Zndex_S : //z 2015-04-27 11:28:04 L.248'45116 T1418964723.K ~0   +----+----+----+----+----+
      L288 ,   1:R#.1    @日知录
      L296 ,   2:R#.2    @第17周总结 2015-04-26 --> 2015-05-02
      L300 ,   3:zdo focus windows system programming 以及工程实践。
      L303 ,   4:zkaizen 纯粹的肥肉还是别吃了；肉食类不要吃冷的。饭店吃饭尽量点热的。
      L314 ,   5:R#.3    @国务院办公厅关于2015年部分节假日安排的通知
      L334 ,   6:R#.4    @流程图 软件推荐
      L356 ,   7:todo 阅读《我用VISIO制图》done 2015-04-28 16:26 当晚未看。
      L359 ,   8:R#.5    @绘制类图，类继承
      L364 ,   9:R#.6    @EA公司发表自制的EASTL规格 游戏开发方面对STL的性能及功能需求的特点
      L368 ,  10:R#.7    @参考下 cp 上的 tl 功能，看能否增强n.tl
      L373 ,  11:R#.8    @收集方方面面的模式和实例。
      L379 ,  12:R#.9    @收集一份vc6的常用插件
      L384 ,  13:R#.10   @zdo 使用 libcurl 写个http post[简繁转化]的例子
      L389 ,  14:R#.11   @关灯吃面
      L397 ,  15:R#.12   @znote astyle -A1 -R -z1 -n *.cpp
      L401 ,  16:R#.13   @zlog hosts
      L404 ,  17:zkz Moving from Research to Practice to Close the Achievement Gap
      L407 ,  18:R#.14   @3ds max
      L459 ,  19:zitem haptix/evolution3d googlecode
      L461 ,  20:znote 3ds max 2015 中文帮助 http://help.autodesk.com/view/3DSMAX/2015/CHS/ 
      L464 ,  21:R#.15   @CMakeFile
      L501 ,  22:R#.16   @3ds
      L511 ,  23:zitem freeimage 结合play，载入其他类型素材（不限于tga）
      L526 ,  24:R#.17   @high performance lock
      L537 ,  25:R#.18   @3ds
      L546 ,  26:R#.19   @znote BookList
      L549 ,  27:todo 深入理解nginx redis设计与实现
      L594 ,  28:todo http://download.csdn.net/download/chengdz599/8792741 ??
      L611 ,  29:R#.20   @书评
      L628 ,  30:R#.21   @Game tmp
      L642 ,  31:R#.22   @了解下 markdown 以及 lua
      L646 ,  32:R#.23   @Matthew Fisher graphics project
      L652 ,  33:zitem dx 10 的例子
      L656 ,  34:R#.24   @leetcode
      L695 ,  35:R#.25   @一些 game engine 
      L740 ,  36:znote 一系列的 how to ，如 How to: Create a Constant Buffer
      L748 ,  37:R#.26   @znote merida 山地车
      L754 ,  38:R#.27   @shader
      L768 ,  39:znote an introduction to hlsl。一步一步，易懂好理解。
      L837 ,  40:R#.28   @DirectX Tool Kit
      L928 ,  41:todo 把npp plugins intel slotion 给去掉。 done
      L944 ,  42:R#.29   @Math
      L950 ,  43:R#.30   @matrix
      L984 ,  44:R#.31   @Get pitch, yaw, roll from Quaternion
      L1020,  45:R#.32   @3ds max exporter
      L1046,  46:R#.33   @骨骼动画 cal3d
      L1063,  47:R#.34   @腿长和车架上管计算公式 腿长*0.65=上管cm，例子 75*0.65=48.75cm
      L1072,  48:R#.35   @svn E155037 以前的操作没有完成
      L1080,  49:R#.36   @matrix 操作
      L1104,  50:R#.37   @COLLADA 动画
      L1138,  51:R#.38   @cpp11
      L1144,  52:R#.39   @fbx
      L1158,  53:R#.40   @dx？ 课程
      L1165,  54:R#.41   @MS dx 资源整理
      L1205,  55:R#.42   @NVIDIA Professional Graphics Samples
      L1221,  56:R#.43   @fbx animation
      L1245,  57:R#.44   @directx sdk 一些使用说明
      L1248,  58:todo http://blogs.msdn.com/b/chuckw/ 多看看该 blog 
     Zndex_E : //z 2016-04-26 23:39:06 L.249'1254  T3808900858.K ~1153+----+----+----+----+----+
     TimeCnt : //z 2016-01-07 20:36:13 L.359'12227 T122349006 .K ~70  +----+----+----+----+----+
     Reg.Cnt : //z 2016-04-26 23:38:34 L.249'1286  T3808865018.K ~45  +----+----+----+----+----+
     #45  R+ : //z 2016-04-26 23:38:34 L.249'1286  T3808865018.K ~45    V+.1194 L+.1264 
     ...
     #21  R+ : //z 2015-07-01 18:10:34 L.183'20966 T981018703 .K ~21    V+.448  L+.490  
     #20  R+ : //z 2015-06-24 13:07:42 L.190'39138 T2164378419.K ~20    V+.407  L+.439  
     #19  R+ : //z 2015-06-09 11:00:48 L.205'46752 T4035241523.K ~19    V+.363  L+.380  
     #18  R+ : //z 2015-06-05 17:33:01 L.209'23219 T2926574672.K ~18    V+.354  L+.368  
     #17  R+ : //z 2015-06-04 16:18:43 L.210'27677 T1565113303.K ~17    V+.334  L+.354  
     #16  R+ : //z 2015-05-28 17:45:17 L.217'22483 T1979531806.K ~16    V+.295  L+.337  
     ...
     File.Op : //z 2016-04-26 21:19:22 L.249'9638  T1223593140.K ~6   +----+----+----+----+----+
     #6   O+ : //z 2016-04-26 21:19:22 L.249'9638  T1223593140.K ~6     V+.1191 L+.1    
     #5   O+ : //z 2016-03-10 00:13:55 L.296'85565 T913454793 .K ~5     V+.1184 L+.1    
     ...
     Version : //z 2016-04-26 23:39:06 L.249'1254  T3808900858.K ~1198  R+.45   L+.1266 --+----+
     #63  V+ : //z 2016-04-26 23:38:46 L.249'1274  T3808865053.K ~1197  R+.45   L+.1263 
     #62  R+ : //z 2016-04-26 23:38:34 L.249'1286  T3808865018.K ~1194  R+.45   L+.1265 V+.1194 
     ...
     #58  V+ : //z 2015-12-14 18:09:58 L.17 '21002 T2051895869.K ~1102  R+.43   L+.1159 
     ...
     #52  V+ : //z 2015-10-30 17:54:18 L.62 '21942 T2306606228.K ~988   R+.37   L+.1046 
     #51  V+ : //z 2015-10-19 15:59:14 L.73 '28846 T154138778 .K ~969   R+.37   L+.1027 
     #50  R+ : //z 2015-10-19 15:53:24 L.73 '29196 T153923189 .K ~961   R+.37   L+.1022 V+.961  
     #50  V+ : //z 2015-10-14 15:40:13 L.78 '29987 T4108589834.K ~950   R+.36   L+.1006 
     ...
     #46  V+ : //z 2015-09-30 11:05:33 L.92 '46467 T1247528463.K ~874   R+.33   L+.931  
     #45  R+ : //z 2015-09-30 11:02:00 L.92 '46680 T1247420550.K ~865   R+.33   L+.925  V+.865  
     ...
     #30  R+ : //z 2015-08-06 08:25:18 L.147'56082 T2984249532.K ~573   R+.26   L+.635  V+.573  
     #30  V+ : //z 2015-08-04 12:53:59 L.149'39961 T3362029595.K ~570   R+.25   L+.617  
     #29  V+ : //z 2015-07-30 10:32:40 L.154'48440 T1591220938.K ~551   R+.25   L+.612  
     ...
     #24  R+ : //z 2015-07-06 12:45:55 L.178'40445 T2164889881.K ~474   R+.23   L+.516  V+.474  
     #24  R+ : //z 2015-07-02 15:24:43 L.182'30917 T1470713170.K ~470   R+.22   L+.510  V+.470  
     #24  V+ : //z 2015-07-01 18:10:55 L.183'20945 T981018770 .K ~456   R+.21   L+.494  
     #23  R+ : //z 2015-07-01 18:10:34 L.183'20966 T981018703 .K ~448   R+.21   L+.491  V+.448  
     #23  V+ : //z 2015-06-24 14:58:36 L.190'32484 T3461811901.K ~437   R+.19   L+.466  
     #22  V+ : //z 2015-06-24 13:11:19 L.190'38921 T2165348626.K ~418   R+.19   L+.445  
     #21  R+ : //z 2015-06-24 13:07:42 L.190'39138 T2164378419.K ~407   R+.20   L+.440  V+.407  
     #21  V+ : //z 2015-06-24 13:02:53 L.190'39427 T2164198768.K ~399   R+.19   L+.426  
     #20  V+ : //z 2015-06-24 12:53:53 L.190'39967 T878696341 .K ~380   R+.19   L+.415  
     #19  R+ : //z 2015-06-09 11:00:48 L.205'46752 T4035241523.K ~363   R+.19   L+.381  V+.363  
     #19  V+ : //z 2015-06-05 17:33:48 L.209'23172 T2926574811.K ~361   R+.18   L+.373  
     #18  R+ : //z 2015-06-05 17:33:01 L.209'23219 T2926574672.K ~354   R+.18   L+.369  V+.354  
     #18  V+ : //z 2015-06-04 16:19:29 L.210'27631 T1565149180.K ~342   R+.17   L+.357  
     #17  R+ : //z 2015-06-04 16:18:43 L.210'27677 T1565113303.K ~334   R+.17   L+.355  V+.334  
     #17  V+ : //z 2015-05-29 16:01:55 L.216'28685 T750977912 .K ~323   R+.16   L+.347  
     #16  V+ : //z 2015-05-28 17:46:03 L.217'22437 T1979567706.K ~304   R+.16   L+.342  
     #15  R+ : //z 2015-05-28 17:45:17 L.217'22483 T1979531806.K ~295   R+.16   L+.338  V+.295  
     ...
     K Kersi : //z 2015-11-24 20:09:38 L.37 '13822 T884673684 .K ~1021  R+.39   L+.1080 
     KVersio : //z 2015-08-13 17:33:16 L.140'23204 T3396706935.K ~599   R+.27   L+.649  
     K Versi : //z 2015-07-01 18:10:59 L.183'20941 T981018774 .K ~457   R+.21   L+.495  
     K  Vers : //z 2015-06-04 16:19:53 L.210'27607 T1565149273.K ~347   R+.17   L+.361  
...
2015-05-26 16:59 zitem haptix/evolution3d googlecode

2015-12-17 13:21 znote 3ds max 2015 中文帮助 http://help.autodesk.com/view/3DSMAX/2015/CHS/ 
...
#region 05-28 17:45 R#.16   @3ds
01. 3ds 相关工具
lib3ds
3ds dump
3ds play
http://www.gametutorials.com/ s 3ds
潘李亮 evlution 3d
...
//z 2015-06-04 16:18:56 L.210'27664 T1565113339.K[T12,L354,R17,V337]
01. 很多地方采用的轮询的方式。
...
#endregion //z 2015-06-04 16:18:43 L.210'27677 BG57IV3@XCL T1565113303.K.F4146951713-+----+----+

#region 06-05 17:33 R#.18   @3ds
01. 
//z 2015-06-05 17:33:06 L.209'23214 T2926574677.K[T13,L369,R18,V356]
http://www.osgart.org/index.php/Using_osgExp_for_3DS_Max
http://trac.openscenegraph.org/projects/osg//wiki/Community/Plugins
http://sourceforge.net/p/osgmaxexp/news/
http://sourceforge.net/p/osgmaxexp/code/HEAD/tree/
#endregion //z 2015-06-05 17:33:01 L.209'23219 BG57IV3@XCL T2926574672.K.F4146951713-+----+----+

#region 06-09 11:00 R#.19   @znote BookList
01. 
//z 2015-06-09 11:00:50 L.205'46750 T4035241548.K[T14,L381,R19,V365]
05-25 12:54 todo 深入理解nginx redis设计与实现
深入应用C++11：代码优化与工程级应用

//z 2015-06-18 08:36:25 L.196'55415 T2695262781.K[T15,L411,R19,V375]
http://sale.jd.com/act/Pfj50sdUDAJ.html

//z 2015-06-24 12:53:49 L.190'39971 T878696314 .K[T16,L414,R19,V378]
游戏机制:高级游戏设计技术
通关!游戏设计之道
游戏设计要则探秘
...
networking-for-game-programmers (博客)
...
我所理解的Cocos2d-x
这本书适合有Cocos2d-x基础的人读
本书完全基于Cocos2d-x3.0，深度剖析计算机图形学，OpenGL ES及游戏引擎架构，全面提升游戏开发相关知识。

CUDA并行程序设计:GPU编程指南
已看完！不否认这是一本好书，但是它非常不适合初学者，本书并没有系统地讲述“cuda c”,而是从硬件架构开始讲，告诉我们更深层次的加速原理，适合有一些cuda 编程基础的人学习，是一本进阶的好书！

C++标准库(第2版)
出版社: 电子工业出版社; 第2版 (2015年6月1日)

Unity游戏设计与实现:南梦宫一线程序员的开发实例
每个案例都会着重的简介一些要点，但是并没有从基础讲起，如果之前没有接触过unity的开发者读起来会有些吃力。
推荐有一定基础的开发者使用。
书不错。

计算机动画算法与技术(第2版) 
目前看不懂，这类书容易绝版，趁着还有，先买了。
比较郁闷的是，点进这本书的英文网站，这本书原来已经第三版了。

Game AI Pro 1
2015-06-30 13:49 todo http://download.csdn.net/download/chengdz599/8792741 ??
Game AI Pro 2
...
代码之殇
近2年来读到的最好的最贴近技术的非技术类书籍。 每一个章节，都找到了自己和身边的团队，项目的影子。直到现在，阅读《人月神话》的时候，都会仰视那些高瞻远瞩的观点，但是不知其所从来，但是这本书可以说是一个桥梁，真正的展开了你身边的问题，你曾经有过但是没有仔细考虑的疑惑，让人明白了，为什么人月是一个神话。 里面的观点比较明确，不一定要同意，但是最重要的是让你思考。 

实战Linux编程精髓
#endregion //z 2015-06-09 11:00:48 L.205'46752 BG57IV3@XCL T4035241523.K.F4146951713-+----+----+

#region 06-24 13:07 R#.20   @书评
01. OpenGL ES应用开发实践指南(Android卷)
以前有出版讲Android OpenGL ES的资料，但是它们主要在讲OpenGL ES1.0的固定管线，现在来看这些早已落伍了。
本书摒弃了固定管线，全部采用glsl来编写着色器，尤其是讲到了粒子系统的时候，让读者深刻体会到了可编程着色器的强大威力。

本书还较详细的讲解了计算机图形学的基本数学知识，主要集中在投影算法，仿射变换，线性插值，朗伯反射光强算法。这些数学知识其实是很基础的，有高中的数学知识就可以掌握。其他很多非专业计算机图形学的教材中，都是把这些数学知识当成公式使用，而本书由浅入深的讲解了这些知识，并在后续每一次使用时，都回顾并强调它们，让非计算机图形学专业的读者也可以体会到这些数学知识的作用。

贯穿全书的两大工程，一个小游戏，和一个粒子系统，一步一步教会读者搭建Android下OpenGL编程的框架，主要有glsl的编译框架、材质贴图的加载框架、对象的数据绑定框架。

作者在教学中不断指出，OpenGL是图形编程很基础的东西，在其基础上有很多开源框架，你如果直接学习这些框架，而不具备图像编程的基础知识，会有一种空中楼阁的感觉，他建议在完成本书后可以学习一两个开源框架，通过成熟的框架来帮助你具备工业级开发的能力。在最后一章也较详细的讲述了，完成本书的学习后如果想进一步在图像编程发展，可以怎么做。
我读的时候本书还没翻译，读原版虽然被图形学的词汇绕的有点晕，但还是坚持下来了觉得收获很大，让我一个没接触过3D图像编程的Android码农真正的入门了。现在翻译版上架，写一些自己的读后感，作为对原作者诚意作品的感谢。

//z 2015-09-30 13:45:42 L.92 '36858 T3835208117.K[T45,L550,R20,V882]
Advanced Lighting and Materials with Shaders
By Kelly Dempski, Emmanuel Viale
#endregion //z 2015-06-24 13:07:42 L.190'39138 BG57IV3@XCL T2164378419.K.F4146951713-+----+----+

#region 07-01 18:10 R#.21   @Game tmp
//z 2015-07-01 18:10:36 L.183'20964 T981018705 .K[T17,L490,R21,V450]
01. 
http://pan.baidu.com/wap/link?shareid=2612482638&uk=3206192511&third=0&page=1&dir=/%E8%AE%A1%E7%AE%97%E6%9C%BA%E7%94%B5%E5%AD%90%E4%B9%A6&

http://pan.baidu.com/wap/share/home?uk=1479591397&third=0

http://pan.baidu.com/wap/share/home?uk=2703695769&third=0

http://pan.baidu.com/wap/link?uk=3875563743&shareid=3203641348&third=0

http://pan.baidu.com/wap/link?shareid=1955113446&uk=1142351078&third=0&dir=%2F%E3%80%90%E7%A6%8F%E5%88%A9%E3%80%91%E6%B8%B8%E6%88%8F%E7%BC%96%E7%A8%8B%E5%AD%A6%E4%B9%A0%E8%B5%84%E6%96%99%20by%E6%B5%85%E5%A2%A8_%E6%AF%9B%E6%98%9F%E4%BA%91&page=1&
#endregion //z 2015-07-01 18:10:34 L.183'20966 BG57IV3@XCL T981018703 .K.F4146951713-+----+----+

#region 07-02 15:24 R#.22   @了解下 markdown 以及 lua
01. 
#endregion //z 2015-07-02 15:24:43 L.182'30917 BG57IV3@XCL T1470713170.K.F4146951713-+----+----+

#region 07-06 12:45 R#.23   @Matthew Fisher graphics project
//z 2015-07-06 12:45:58 L.178'40442 T2164889884.K[T18,L516,R23,V476]
01. 
https://graphics.stanford.edu/~mdfisher/projects.html
https://graphics.stanford.edu/~mdfisher/BaseCode.html

2015-07-08 18:34 zitem dx 10 的例子
http://www.braynzarsoft.net/index.php?p=DX10Lessons
#endregion //z 2015-07-06 12:45:55 L.178'40445 BG57IV3@XCL T2164889881.K.F4146951713-+----+----+

#region 07-16 13:06 R#.24   @leetcode
//z 2015-07-16 13:06:51 L.168'39189 T1394128244.K[T19,L528,R24,V490]
01. 
http://algorithm.yuanbin.me/
http://www.jiuzhang.com/solutions/
http://www.jiuzhang.com/
http://coolshell.cn/articles/12052.html#more-12052
https://www.gitbook.com/book/siddontang/leetcode-solution/details
http://www.raychase.net/2763

//z 2015-07-16 13:08:03 L.168'39117 T1394199955.K[T20,L536,R24,V496]
http://blog.csdn.net/havenoidea/article/category/1640099

//z 2015-07-16 13:11:21 L.168'38919 T1395134381.K[T21,L541,R24,V499]
...
//z 2015-07-23 15:09:48 L.161'31812 T1716245981.K[T22,L601,R25,V542]
dx 11 例子
http://rastertek.com/index.html
FW1FontWrapper is a font wrapper library for drawing text using Direct3D 11.
http://fw1.codeplex.com/

//z 2015-07-29 17:13:44 L.155'24376 T411993180 .K[T23,L607,R25,V548]
一些 game 和 dx 的例子
http://www.toymaker.info/index.html

//z 2015-07-30 10:32:39 L.154'48441 T1591220914.K[T24,L611,R25,V551]
...
#region 08-06 08:25 R#.26   @znote merida 山地车
//z 2015-08-06 08:25:43 L.147'56057 T2984249626.K[T26,L634,R26,V577]
01. 座杆 80mm，车把80mm，直径 25.4
02. 立杆 90mm ，直径 28.6
#endregion //z 2015-08-06 08:25:18 L.147'56082 BG57IV3@BYH T2984249532.K.F4146951713-+----+----+

#region 08-13 17:31 R#.27   @shader
//z 2015-08-13 17:32:04 L.140'23276 T3396670963.K[T27,L642,R27,V586]
01. 
Shadertoy
https://www.shadertoy.com/
只有画布的座标以及一些额外的输入，然后你可用GLSL shader画任何东西。
windows 下的shader开发环境有 rendermonkey
...
dxut 剖析
http://www.cppblog.com/lovedday/archive/2008/05/19/50388.html
...
//z 2015-09-05 20:38:27 L.117'12093 T1845101210.K[T31,L790,R28,V751]
2015-09-05 20:38 todo 把npp plugins intel slotion 给去掉。 done
一些game相关的代码
https://github.com/bagobor?tab=repositories

//z 2015-09-07 09:52:04 L.115'50876 T1383629914.K[T32,L797,R28,V760]
Antialiasing: Wu Algorithm，彩色版本
http://www.suchit-tiwari.org/download/aawu.c

//z 2015-09-10 13:19:13 L.112'38447 T3651870418.K[T33,L802,R28,V766]
一些绿幕 clip 
http://www.hollywoodcamerawork.com/greenscreenplates.html

//z csdn 几篇 dx 教程
http://blog.csdn.net/fox64194167/article/details/8073920
#endregion //z 2015-08-18 18:06:06 L.135'21234 BG57IV3@XCL T728764508 .K.F4146951713-+----+----+

#region 09-22 17:22 R#.29   @Math
//z 2015-09-22 17:22:20 L.100'23860 T2601790289.K[T34,L813,R29,V778]
01. 
http://www.euclideanspace.com/maths/geometry/rotations/conversions/matrixToEuler/
#endregion //z 2015-09-22 17:22:14 L.100'23866 BG57IV3@XCL T2601790260.K.F4146951713-+----+----+

#region 09-24 20:55 R#.30   @matrix
//z 2015-09-24 20:55:28 L.98 '11072 T1959487451.K[T35,L821,R30,V781]
01. 
//z 2015-09-24 22:04:52 L.98 '6908  T241490644 .K[T36,L823,R30,V785] 矩阵操作
https://github.com/gamedevforks/LibGizmo
Open 3D Model Viewer - A quick and powerful 3D model viewer http://www.open3mod.com
https://github.com/gamedevforks/open3mod
an open source c++ 3d skeletal animation engine
https://github.com/gamedevforks/ozz-animation
...
#region 09-30 11:02 R#.33   @骨骼动画 cal3d
01. 
//z 2015-09-30 11:02:02 L.92 '46678 T1247420552.K[T44,L925,R33,V866]
使用cal3d骨骼动画
http://www.jeepshoe.org/692605504.htm

3ds Max中导出Cal3D骨骼动画
http://ranjiao.com/blog/index.php/tag/cal3d/

Cal3d
http://gna.org/projects/cal3d/

//z 2015-09-30 14:05:43 L.92 '35657 T826965107 .K[T46,L943,R33,V884]
Tools, tools, tools 关于图形学的一些工具
http://www.realtimerendering.com/blog/tag/directcompute/
#endregion //z 2015-09-30 11:02:00 L.92 '46680 BG57IV3@XCL T1247420550.K.F4146951713-+----+----+

#region 10-05 21:05 R#.34   @腿长和车架上管计算公式 腿长*0.65=上管cm，例子 75*0.65=48.75cm
//z 2015-10-05 21:05:30 L.87 '10470 T732247271 .K[T47,L950,R34,V895]
01. 

车架参数：
1、中管选用31.8合适最常用的前拔口径，安装更方便
2、座杆适用27.2的管径
#endregion //z 2015-10-05 21:05:28 L.87 '10472 BG57IV3@BYH T732247246 .K.F4146951713-+----+----+

#region 10-08 11:36 R#.35   @svn E155037 以前的操作没有完成
01. svn: E155037: 以前的操作没有完成；如果它被中断，请执行“svn cleanup”
看起来， svn处理命令时有时会卡住获取/ 操作。 所有这些操作将存储在数据库文件中的wc.db .svn文件夹。 
...
//z 2015-10-09 12:47:54 L.83 '40326 T2630966359.K[T50,L1002,R36,V948]
vb 写的与dx8 相关的东西

//z 2015-10-14 15:40:12 L.78 '29988 T4108589833.K[T51,L1005,R36,V950]
有游戏实例，以及一些与数学相关的东西
http://sacredsoftware.net/
...
#region 10-19 15:53 R#.37   @COLLADA 动画
//z 2015-10-19 15:53:26 L.73 '29194 T153923191 .K[T52,L1021,R37,V963]
01. 
https://en.wikipedia.org/wiki/COLLADA#Libraries
https://www.khronos.org/collada/wiki/FCollada

//z 2015-10-19 15:59:16 L.73 '28844 T154138780 .K[T53,L1027,R37,V971]
选择一种合适的文件作为动画文件格式

//z 2015-10-20 10:41:58 L.72 '47882 BG57IV3@XCL T3912493292.K.F4146951713[T54,L1030,R37,V974]
...
shader
http://www.zhihu.com/question/24114911#
学习dx
http://www.zhihu.com/question/23713648
Nehe OpenGL 教程
http://www.zhihu.com/question/24162747#
http://www.kevinbeason.com/smallpt/
图形学好书
http://www.zhihu.com/question/27525631

http://www.scratchapixel.com/

如果不是大牛，知乎上有关图形学的问题基本上看Milo Yip就足够了，水平高，热于且善于分享。我仔细看过的图形学书籍（系统的学习计算机图形学，有哪些不同阶段的书籍的推荐？ - Milo Yip 的回答中列的书或多或少都看过）中，感觉基础阶段最好的是《Fundamentals of Computer Graphics, Third Edition (豆瓣)》，实践的话《Interactive Computer Graphics: A Top-Down Approach with OpenGL》也不错。RTR仔细通读前四章，后面的一边实践一边慢慢读
#endregion //z 2015-10-19 15:53:24 L.73 '29196 BG57IV3@XCL T153923189 .K.F4146951713-+----+----+

#region 11-23 13:10 R#.38   @cpp11
//z 2015-11-23 13:10:42 L.38 '38958 T728401416 .K[T57,L1072,R38,V1016]
01. 使用 cpp 11 改进程序
http://www.cnblogs.com/qicosmos/category/490693.html
#endregion //z 2015-11-23 13:10:33 L.38 '38967 BG57IV3@XCL T728401384 .K.F4146951713-+----+----+

#region 11-24 20:09 R#.39   @fbx
01. 
//z 2015-11-19 15:54:56 L.42 '29104 T1485587644.K[T55,L1057,R37,V996]
Building blocks for generative art and computational design projects. Ranging from audio-visual interactive installations to generative design tools. http://www.field.io/process
https://github.com/field/FieldKit.cpp.git

//z 2015-11-19 16:42:09 L.42 '26271 BG57IV3@XCL T2775797656.K.F4146951713[T56,L1061,R37,V1004]
一个d x 11 eng ine，读入f b x
svn checkout http://dx11-engine.googlecode.com/svn/trunk/ dx11-engine
一个 fbx viewer
...
shaderx 6 subvision 例子 2016-01-14 13:21
svn checkout http://rendervista.googlecode.com/svn/trunk/ rendervista
#endregion //z 2015-12-04 11:46:13 L.27 '44027 BG57IV3@XCL T3663712269.K.F4146951713-+----+----+

#region 12-07 14:04 R#.42   @NVIDIA Professional Graphics Samples
//z 2015-12-07 14:04:12 L.24 '35748 T3441737452.K[T61,L1137,R42,V1069]
01. nvidia 例子
https://github.com/nvpro-samples

//z 2015-12-22 17:50:11 L.9  '22189 T2867876620.K[T67,L1148,R42,V1115]
...
//z 2015-12-25 16:59:06 L.6  '25254 T1780136187.K[T69,L1171,R43,V1133]
skeleton animations webgl
svn checkout http://webgl-gorbatras.googlecode.com/svn/trunk/ webgl-gorbatras-read-only
...
//z 2015-12-14 18:09:58 L.17 '21002 T2051895869.K[T65,L1159,R43,V1102]
C++ 3d skeletal animation engine and tools
https://code.google.com/p/ozz-animation/
https://github.com/galek/ozz-animation.git
#endregion //z 2015-12-11 17:20:18 L.20 '23982 BG57IV3@XCL T559072046 .K.F4146951713-+----+----+

#region 12-15 17:48 R#.44   @directx sdk 一些使用说明
//z 2015-12-15 17:48:58 L.16 '22262 T832937024 .K[T66,L1169,R44,V1106]
01. 
todo http://blogs.msdn.com/b/chuckw/ 多看看该 blog 
The Zombie DirectX SDK
http://blogs.msdn.com/b/chuckw/archive/2015/03/23/the-zombie-directx-sdk.aspx

//z 2015-12-23 16:55:56 L.8  '25444 T1644389850.K[T68,L1188,R44,V1127]
世界空间，坐标转换
http://www.codinglabs.net/article_world_view_projection_matrix.aspx
http://www.cppblog.com/lovedday/archive/2008/05/02/48638.html
#endregion //z 2015-12-15 17:48:47 L.16 '22273 BG57IV3@XCL T832936990 .K.F4146951713-+----+----+

#region 04-26 23:38 R#.45   @stream player
01. 
http://www.codeproject.com/Articles/885869/Stream-Player-control
https://github.com/jacobbo/WebEye.git
#endregion //z 2016-04-26 23:38:34 L.249'1286  BG57IV3@BYH T3808865018.K.F4146951713-+----+----+
