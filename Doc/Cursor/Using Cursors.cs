//z 2015-06-12 15:59:21 L.202'28839 T2380267574.K
Using Cursors
...
2015-06-12 16:00 zitem 使用键盘移动光标
Using the Keyboard to Move the Cursor
...
//
case WM_KEYDOWN:
    //z 只处理这四个键 LEFT RIGHT UP 以及 DOWN。
    ...
    //z 将光标的坐标由 screen 坐标转换为 client 坐标。
