...
public:
    ...
    virtual TWin	*GetParent(void)
    {
        return parent;
    };
    virtual void	SetParent(TWin *_parent)
    {
        parent = _parent;
    };
...
public:
    ...
    u_int	MakeHashId(HWND hWnd)
    {
        return (u_int)hWnd * 0xf3f77d13;
    }
};
...
public:
    ...
    LPCSTR	GetDefaultClass()
    {
        return defaultClass;
    }
    LPCVOID	GetDefaultClassV()
    {
        return (void *)defaultClassV;
    }
    void	AddWin(TWin *win)
    {
        preWnd = win;
    }
...
public:
    ...
    BOOL	CreateKey(LPCSTR subKey)
    {
        return OpenKey(subKey, TRUE);
    }
    BOOL	CreateKeyV(const void *subKey)
    {
        return OpenKeyV(subKey, TRUE);
    }
...
public:
    ...
    const char *GetIniFileName(void)
    {
        return	ini_file;
    }
};
