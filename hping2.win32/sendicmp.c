...
// replaced all _icmp_seq with "sequence"
// hard code src_port to 0 if ICMP type so delay table can be set correctly, do this before each send statement
...
#ifndef WIN32
        delaytable_add(sequence, 0, time(NULL), get_usec(), S_SENT);
#else
