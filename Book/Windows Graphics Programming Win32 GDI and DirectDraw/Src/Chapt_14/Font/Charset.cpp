...
int KCharSetView::OnCommand(int cmd, HWND hWnd)
{
    ...
    case IDM_CP_THAI:
        cs = THAI_CHARSET;
        break;
    case IDM_CP_VIETNAMESE:
        cs = VIETNAMESE_CHARSET;
        break;

    case IDM_CP_CHINESEBIG5:
        cs = CHINESEBIG5_CHARSET;
        row += Map_950.GetSize();
        break; // (0xF9-0xA1+1)*10; break;
    case IDM_CP_GB2312:
        cs = GB2312_CHARSET;
        row += Map_936.GetSize();
        break; // (0xF7-0xA1+1)* 6; break;
    case IDM_CP_SHIFTJIS:
        cs = SHIFTJIS_CHARSET;
        row += Map_932.GetSize();
        break; // (0xFC-0x81+1)*12; break;
    case IDM_CP_HANGUL:
        cs = HANGUL_CHARSET;
        row += Map_949.GetSize();
        break; // (0xFD-0x81+1)*12; break;
