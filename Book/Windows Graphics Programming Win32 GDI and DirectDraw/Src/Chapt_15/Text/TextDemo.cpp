...
void Demo_CharacterPlacement(HDC hDC, const RECT * rcPaint)
{
    ...
    for (int test=0; test<3; test++)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            opt = GCP_USEKERNING | GCP_JUSTIFY;
            break;
        }
...
void Demo_TextStyle(HDC hDC)
{
    ...
    for (int f=0; f<2; f++)
    {
        for (int i=0; i<11; i++)
        {
            ...
            case 7:
                lf.m_lf.lfUnderline = TRUE;
                break;

            case 8:
                lf.m_lf.lfStrikeOut = TRUE;
                break;
...
void Demo_TextGeometry(HDC hDC)
{
    ...
    y0 =  20;
    {
        ...
        TextOutW(hDC, x0, y0, line1, 7);
        x0 -= 45;
        TextOutW(hDC, x0, y0, line2, 7);
        x0 -= 50;
