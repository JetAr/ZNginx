...
//	PolyBezier(hDC, m_bezier, 4);
    ...
    POINT P12;
    P(P12, m_bezier[0], m_bezier[1], t);
    POINT P23;
    P(P23, m_bezier[1], m_bezier[2], t);
    POINT P34;
    P(P34, m_bezier[2], m_bezier[3], t);
...
void KMyCanvas::BezierDemo(HDC hDC)
{
    ...
    for (int z=0; z<=200; z+=40)
    {
        ...
        POINT p[4] = { x, y, x+ 50, y-z, x+100, y-z, x+150, y };
        x+= 160;
        POINT q[4] = { x, y, x+ 50, y-z, x+100, y+z, x+150, y };
        x+= 180;

        POINT r[4] = { x, y, x+170, y-z, x- 20, y-z, x+150, y };
        x+= 200;
        POINT s[4] = { x, y, x+170, y-z, x- 20, y+z, x+150, y };
        x+= 180;
