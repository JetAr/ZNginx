...
void KMyCanvas::TestEllipse(HDC hDC)
{
    ...
    for (int i=0; i<=6; i+=3)
    {
        ...
        {
        case 0:
            Label(hDC, 70, 230, "Solid pen");
            break;
        case 3:
            Label(hDC, 70, 230, "Solid pen, advanced mode");
            break;
        case 6:
            Label(hDC, 70, 230, "Inside frame pen");
            break;
        }
    }
...
void KMyCanvas::TestRegion(HDC hDC)
{
    ...
    for (int i=0; i<6; i++)
    {
        ...
        case 0:
        case 1:
            hRgn = CreateRectRgn(20, 10, 0, 30);
            break;
        case 2:
        case 3:
            hRgn = CreateRoundRectRgn(20, 10, 0, 30, 10, 10);
            break;
        case 4:
        case 5:
            hRgn = CreateEllipticRgn(20, 10, 0, 30);
            break;
        }
        ...
        case 2:
        case 3:
            RoundRect(hDC, 0, 20, 20, 40, 10, 10);
            break;
        case 4:
        case 5:
            Ellipse(hDC, 0, 20, 20, 40);
            break;
        }
        EndPath(hDC);
        StrokeAndFillPath(hDC);
        ...
        case 0:
        case 1:
            Rectangle(hDC, 0, 30, 20, 50);
            break;
        case 2:
        case 3:
            RoundRect(hDC, 0, 30, 20, 50, 10, 10);
            break;
        case 4:
        case 5:
            Ellipse(hDC, 0, 30, 20, 50);
            break;
        }
        EndPath(hDC);
...
void KMyCanvas::TestRegionOper(HDC hDC)
{
    ...
    ////////////////////////////////
    {
        ...
        for (int i=0; i<6; i++)
        {
            ...
            {
            case 1:
                CombineRgn(hRgn, hRgn1, hRgn2, RGN_AND);
                break;
            case 2:
            ...
            case 4:
                ...
                break;
            case 5:
                CombineRgn(hRgn, hRgn1, hRgn2, RGN_COPY);
                break;
            }
    ...
    // Test GetRegionData
    {
        ...
        for (int i=0; i<4; i++)
        {
            ...
            {
            case 0:
                hRgn = CreateRectRgn(0, 0, 21, 21);
                break;
            case 1:
                hRgn = CreateRoundRectRgn(0, 0, 21, 21, 10, 10);
                break;
            case 2:
                hRgn = CreateEllipticRgn(0, 0, 21, 21);
                break;
            case 3:
            {
...
//	SetBkMode(hDC, TRANSPARENT);
    ...
    RoundRect(hDC, 50, 50, 130, 150, 40, 40);
    Label(hDC, 50, 160, "RoundRect");

    HRGN hRgn = CreateRoundRectRgn(50, 50, 130, 150, 40, 40);

    OffsetRgn(hRgn, 90, 0);
    PaintRgn(hDC, hRgn);
    Label(hDC, 140,  30, "PaintRgn");
    OffsetRgn(hRgn, 90, 0);
    FillRgn(hDC, hRgn,  yellow);
    Label(hDC, 230, 160, "FillRgn");
    OffsetRgn(hRgn, 90, 0);
    FrameRgn(hDC, hRgn,  yellow, 1, 1);
    Label(hDC, 320,  30, "FrameRgn(1,1)");
    OffsetRgn(hRgn, 90, 0);
    FrameRgn(hDC, hRgn,  yellow, 1, 10);
    Label(hDC, 410, 160, "FrameRgn(1,10)");
    OffsetRgn(hRgn, 90, 0);
    FrameRgn(hDC, hRgn,  yellow, 10, 1);
    Label(hDC, 500,  30, "FrameRgn(10,1)");
    OffsetRgn(hRgn, 90, 0);
    FrameRgn(hDC, hRgn,  yellow, 10, 10);
    Label(hDC, 590, 160, "FrameRgn(10,10)");
    OffsetRgn(hRgn, 90, 0);
    InvertRgn(hDC, hRgn);
    Label(hDC, 680,  30, "InvertRgn");
...
void KMyCanvas::OnDraw(HDC hDC, const RECT * rcPaint)
{
    ...
    case IDM_TEST_HATCHBRUSH:
        ...
        break;
    case IDM_TEST_SYSCOLORBRUSH:
        TestSysColorBrush(hDC);
        break;
    case IDM_TEST_RECTANGLE:
        TestRectangle(hDC);
        break;
    case IDM_TEST_DRAWFRAMECONTROL:
        TestDrawFrameControl(hDC);
        break;
    case IDM_TEST_ELLIPSE:
        TestEllipse(hDC);
        break;
