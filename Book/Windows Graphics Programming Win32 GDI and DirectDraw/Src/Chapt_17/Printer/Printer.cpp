...
void Demo_LineCurve(HDC hDC, const RECT * rcPaint, int width, int height)
{
...

    {
        ...
        for (int z=0; z<=2000; z+=400)
        {
            ...
            POINT p[4] = { x, y, x+ 400, y-z, x+800, y-z, x+1200, y };
            x+= 1300;
            POINT q[4] = { x, y, x+ 400, y-z, x+800, y+z, x+1200, y };
            x+= 1400;

            POINT r[4] = { x, y, x+1500, y-z, x- 200, y-z, x+1300, y };
            x+= 1800;
            POINT s[4] = { x, y, x+1500, y-z, x- 200, y+z, x+1300, y };
            x+= 1600;
