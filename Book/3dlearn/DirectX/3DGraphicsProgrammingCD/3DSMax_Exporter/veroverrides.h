...
#define MAXVER_INTERNALNAME "asciiexp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "asciiexp.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "ASCII file exporter (plugin)\0"//should  be overidden on a per-dll level
