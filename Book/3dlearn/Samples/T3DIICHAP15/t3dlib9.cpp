/*$T indentinput.cpp GC 1.140 12/29/10 17:26:23 */
 ...
 )	/* bytes per line of zbuffer */
{
	...
	int		v0 = 0, v1 = 1, v2 = 2, temp = 0, tri_type = TRI_TYPE_NONE, irestart = INTERP_LHS;
	int		dx, dy, dyl, dyr,		/* general deltas */
		u, v, z, du, dv, dz, xi, yi,	/* the current interpolated x,y */
		ui, vi, zi,			/* the current interpolated u,v,z */
		index_x, index_y,	/* looping vars */
		x, y,	/* hold general x,y */
		xstart, xend, ystart, yrestart, yend, xl, dxdyl, xr, dxdyr, dudyl, ul, dvdyl, vl, dzdyl, zl, dudyr, ur, dvdyr, vr, dzdyr, zr;
	int		x0, y0, tu0, tv0, tz0,	/* cached vertices */
		x1, y1, tu1, tv1, tz1, x2, y2, tu2, tv2, tz2;
	USHORT	*screen_ptr = NULL, *screen_line = NULL, *textmap = NULL, *dest_buffer = (USHORT *) _dest_buffer;
	UINT	*z_ptr = NULL, *zbuffer = (UINT *) _zbuffer;
	/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
 ...
 )	/* bytes per line of zbuffer */
{
	...
	int		dx, dy, dyl, dyr,		/* general deltas */
		...
		index_x, index_y,	/* looping vars */
		x, y,	/* hold general x,y */
		xstart, xend, ystart, yrestart, yend, xl, dxdyl, xr, dxdyr, dudyl, ul, dzdyl, zl, dvdyl, vl, dudyr, ur, dvdyr, vr, dzdyr, zr;
	...
	if(FCMP(face->tvlist[v0].y, face->tvlist[v1].y))
	{
		...
		*/
		...
		else if(tri_type == TRI_TYPE_GENERAL)
		{
			...
			/*
			* Write_Error("\nin tri general: x0=%d, y0=%d, x1=%d, y1=%d, x2=%d, y2=%d", x0,
			* y0, x1, y1, x2, y2);
			* * first test for bottom clip, always
			*/
			if((yend = y2) > max_clip_y) yend = max_clip_y;
 ...
 )	/* bytes per line of zbuffer */
{
	...
	*/
	int		v0 = 0, v1 = 1, v2 = 2, temp = 0, tri_type = TRI_TYPE_NONE, irestart = INTERP_LHS;
	int		dx, dy, dyl, dyr,			/* general deltas */
		u, v, w, z, du, dv, dw, dz, xi, yi, /* the current interpolated x,y */
		ui, vi, wi, zi,		/* the current interpolated u,v,w,z */
		index_x, index_y,	/* looping vars */
		x, y,	/* hold general x,y */
		xstart, xend, ystart, yrestart, yend, xl, dxdyl, xr, dxdyr, dudyl, ul, dvdyl, vl, dwdyl, wl, dzdyl, zl, dudyr, ur, dvdyr, vr, dwdyr, wr, dzdyr, zr;
	int		x0, y0, tu0, tv0, tw0, tz0, /* cached vertices */
		x1, y1, tu1, tv1, tw1, tz1, x2, y2, tu2, tv2, tw2, tz2;
...
int Create_Zbuffer
(
 ZBUFFERV1_PTR	zb,		/* pointer to a zbuffer object */
 int				width,	/* width */
 int				height, /* height */
 int				attr
 )	/* attributes of zbuffer */
{
