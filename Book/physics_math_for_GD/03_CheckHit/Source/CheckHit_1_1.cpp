...
F_RECT			rcRect_A, rcRect_B;				// 矩形Ａ、Ｂ


int InitRect( void )						// 只在程序开始时调用一次
{
    rcRect_A.fLeft  = 100.0f;
    rcRect_A.fTop = 100.0f;
    rcRect_A.fRight = 250.0f;
    rcRect_A.fBottom = 200.0f;
    rcRect_B.fLeft  = 300.0f;
    rcRect_B.fTop = 150.0f;
    rcRect_B.fRight = 400.0f;
    rcRect_B.fBottom = 300.0f;
...
HRESULT Render( void )
{
    ...
    DrawPictureExpWithColor( rcRect_A.fLeft, rcRect_A.fTop, rcRect_A.fRight, rcRect_A.fBottom, &g_tRect_A, nRectA_Color );
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "CheckHit_1_1" ),
