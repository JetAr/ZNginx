...
int InitShapes( void )						// 只在程序开始时调用一次
{
    ...
    crCircleA.y = 100.0f;
    crCircleA.r = 70.0f;
    rcRectCircleB.x  = 250.0f;
    rcRectCircleB.y  = 200.0f;
    rcRectCircleB.vx = 200.0f;
...
//	DrawCircleWithColor( crCircleB.x, crCircleB.y, crCircleB.r, &g_tRect_B, 0xc0ffffff );
    if ( CheckHit( &crCircleA, &rcRectCircleB ) )
    {
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "CheckHit_3_1" ),
