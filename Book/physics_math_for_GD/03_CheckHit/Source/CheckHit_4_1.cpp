...
int InitShapes( void )						// 只在程序开始时调用一次
{
    ...
    faFanB.r = 200.0f;
    faFanB.vx1 = faFanB.r * cosf( faFanB.fAngle1 );
    faFanB.vy1 = faFanB.r * sinf( faFanB.fAngle1 );
    faFanB.vx2 = faFanB.r * cosf( faFanB.fAngle2 );
    faFanB.vy2 = faFanB.r * sinf( faFanB.fAngle2 );
