...
int DrawChangingPictures( void )						// 每帧调用
{
    ...
    xt[0] = VIEW_WIDTH - VIEW_WIDTH / 2.0f;
    yt[0] = 0.0f       - VIEW_WIDTH / 2.0f;
    xt[1] = VIEW_WIDTH + fBoundary_t;
    yt[1] = 0.0f       + fBoundary_t;
    xt[2] = VIEW_WIDTH + VIEW_HEIGHT / 2.0f;
    yt[2] = 0.0f       + VIEW_HEIGHT / 2.0f;
    for ( i = 0; i < 3; i++ )
    {
        xb[i] = xt[i] - VIEW_WIDTH;
    ...
    Draw2DPolygon( xt[0], yt[0], xt[0] / VIEW_WIDTH, yt[0] / VIEW_HEIGHT,
                   ...
                   &g_tPic2 );
    Draw2DPolygon( xt[1], yt[1], xt[1] / VIEW_WIDTH, yt[1] / VIEW_HEIGHT,
                   xb[0], yb[0], xb[0] / VIEW_WIDTH, yb[0] / VIEW_HEIGHT,
                   xb[1], yb[1], xb[1] / VIEW_WIDTH, yb[1] / VIEW_HEIGHT,
                   &g_tPic2 );
    Draw2DPolygon( xt[1], yt[1], xt[1] / VIEW_WIDTH, yt[1] / VIEW_HEIGHT,
                   xb[1], yb[1], xb[1] / VIEW_WIDTH, yb[1] / VIEW_HEIGHT,
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "Wipe_2_1" ),
