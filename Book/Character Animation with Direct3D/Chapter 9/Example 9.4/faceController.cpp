...
FaceController::FaceController(D3DXVECTOR3 pos, Face *pFace)
{
    ...
    m_eyes[0].Init(D3DXVECTOR3(pos.x - 0.037f, pos.y + 0.04f, pos.z - 0.057f), textureIndex);
    m_eyes[1].Init(D3DXVECTOR3(pos.x + 0.037f, pos.y + 0.04f, pos.z - 0.057f), textureIndex);
}
