...
D3DXVECTOR4			g_lightPos(-10.0f, 75.0f, -10.0f, 0.0f);
...
HRESULT Application::Init(HINSTANCE hInstance, bool windowed)
{
    ...
    m_mainWindow = CreateWindow("D3DWND",	//Window class to use
                                "Character Animation with Direct3D: Example 13.1", //Title
...
void Application::Render()
{
    if(!m_deviceLost)
    {
        try
        {
            ...
            D3DXMatrixLookAtLH(&view, &D3DXVECTOR3(0.0f, 20.0f, -20.0f), &D3DXVECTOR3(0.0f, 10.0f, 0.0f), &D3DXVECTOR3(0.0f, 1.0f, 0.0f));
...
void Application::Cleanup()
{
    ...
    //if(m_pFlock != NULL)	delete m_pFlock;
