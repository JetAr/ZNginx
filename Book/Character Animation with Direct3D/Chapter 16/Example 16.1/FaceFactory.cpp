...
FaceFactory::FaceFactory(string filename)
{
    ...
    //Load textures
    string fNames[8] = {"resources/facefactory/face01.jpg", "resources/facefactory/face02.jpg",
                        "resources/facefactory/face03.jpg", "resources/facefactory/face04.jpg",
                        "resources/facefactory/face05.jpg", "resources/facefactory/face06.jpg",
                        "resources/facefactory/face07.jpg", "resources/facefactory/face08.jpg"
                       };
...
ID3DXMesh* FaceFactory::CreateMorphTarget(ID3DXMesh* mesh, vector<float> &morphWeights)
{
    ...
    newMesh->LockVertexBuffer(D3DLOCK_READONLY, (void**)&vDest);
