...
HRESULT Application::Init(HINSTANCE hInstance, bool windowed)
{
    ...
    RegisterClass(&wc);
    m_mainWindow = ::CreateWindow("D3DWND", "Character Animation with Direct3D: Example 15.1", WS_OVERLAPPEDWINDOW, 0, 0, rc.right - rc.left, rc.bottom - rc.top, 0, 0, hInstance, 0);
    SetCursor(NULL);
...
void Application::Render()
{
    if(!m_deviceLost)
    {
        try
        {
            ...
            D3DXMatrixLookAtLH(&view, &D3DXVECTOR3(0.0f, 6.0f, 8.0f), &D3DXVECTOR3(0.0f, 2.0f, 0.0f), &D3DXVECTOR3(0.0f, 1.0f, 0.0f));
            ...
            if(SUCCEEDED(g_pDevice->BeginScene()))
            {
                ...
                RECT rc = {10, 10, 0, 0};
                g_pFont->DrawText(NULL, "SPACE: Wireframe rendering", -1, &rc, DT_LEFT | DT_TOP | DT_NOCLIP, 0x88000000);
