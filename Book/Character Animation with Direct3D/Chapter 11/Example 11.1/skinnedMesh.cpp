...
{
public:
    virtual HRESULT STDMETHODCALLTYPE CreateFrame(LPCSTR Name, LPD3DXFRAME *ppNewFrame);
    virtual HRESULT STDMETHODCALLTYPE CreateMeshContainer(THIS_ LPCTSTR Name, CONST D3DXMESHDATA * pMeshData, CONST D3DXMATERIAL * pMaterials, CONST D3DXEFFECTINSTANCE * pEffectInstances, DWORD NumMaterials, CONST DWORD * pAdjacency, LPD3DXSKININFO pSkinInfo, LPD3DXMESHCONTAINER * ppNewMeshContainer);
    virtual HRESULT STDMETHODCALLTYPE DestroyFrame(THIS_ LPD3DXFRAME pFrameToFree);
    virtual HRESULT STDMETHODCALLTYPE DestroyMeshContainer(THIS_ LPD3DXMESHCONTAINER pMeshContainerBase);
};
