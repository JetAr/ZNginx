#ifdef ___FUNCTIONAL_H_CYCLE__
#error Cyclic dependency discovered: functional.h
#endif
...
/** \file
    Includes all function handling related headers.
*/
