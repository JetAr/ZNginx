...
namespace WCP_NS 
{
    ...
    public:
        ...
        /// </summary>
        void reset() { set_storage(0, false); }
        ...
        /// Returns a data %reference counter value.
        /// </summary>
        long use_count() const { return pstg ? pstg->ptr_ref_count() : 0; }
        ...
        bool unique() const { return use_count() < 2; }

        /// <summary>
        /// Checks if a resource is owned.
        /// </summary>
        /// <returns>true if a data is owned.</returns>
        operator bool () const { return pstg != 0; }
