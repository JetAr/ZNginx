#ifdef ___SYNC_H_CYCLE__
#error Cyclic dependency discovered: sync.h
#endif
...
/** \file
    Includes all synchronization related headers.
*/


#include "_synchronizable.h"
#include "_so_cs.h"
