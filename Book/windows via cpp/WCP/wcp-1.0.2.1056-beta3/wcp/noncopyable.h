#ifdef ___NONCOPYABLE_H_CYCLE__
#error Cyclic dependency discovered: noncopyable.h
#endif
...
#define __NONCOPYABLE_H_CYCLE__
...
/** \file
    Contains the noncopyable class implementation.
*/
...
namespace WCP_NS 
{
    ...
    /// unless they override a copy constructor and assignment operator
