#ifdef ____STINIT_H_CYCLE__
#error Cyclic dependency discovered: _stinit.h
#endif

#ifndef ___STINIT_H__


#ifndef DOXYGEN

#define ___STINIT_H__
#define ___STINIT_H_CYCLE__
...
#define STATIC_INITIALIZATION(Singleton)            \
    namespace initializers {                        \
        namespace {                                 \
            int _##Singleton##_initializer = (      \
                Singleton::singleton_object_type_t  \
                ::instance(), 0); }                 \
    }
