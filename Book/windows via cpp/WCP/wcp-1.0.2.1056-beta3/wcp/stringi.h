...
namespace std
{
    ...
    public:
        ...
        const CharT* data() const { return m_str.data(); }
        ...
        void swap(self_t& s) { m_str.swap(s.m_str); }
        ...
        iterator insert(iterator pos, const CharT& c) { return m_str.insert(pos, c); }
        ...
        template <class InputIterator> void insert(iterator pos,
            InputIterator f, InputIterator l) { m_str.insert(pos, f, l); }
        ...
        /// <param name='c'>Character to insert.</param>
        void insert(iterator pos, size_type n, const CharT& c) { m_str.insert(pos, n, c); }
        ...
        /// <param name='c'>Character to append.</param>
        void push_back(CharT c) { m_str.push_back(c); }
        ...
        iterator erase(iterator p)  { return m_str.erase(p); }
        ...
        void resize(size_type n, CharT c = CharT()) { m_str.resize(n, c); }
        
        /// <summary>Synonym for operator= .</summary>
        /// <param name='rhs'>String to assign to.</param>
        /// <returns>Reference to itself.</returns>
        self_t& assign(const self_t& rhs) { return *this = rhs; } 
    ...
    public:
        ...
        locale& getloc() { return m_loc; }
        
        /// <summary>Returns a locale associated with a string.</summary>
        /// <returns>A locale associated with a string.</returns>
        const locale& getloc() const { return m_loc; }

        /// <summary>
        /// Returns a %reference to a standard STL string.
        /// </summary>
        /// <returns>Reference to a standard STL string.</returns>
        stdstring_t& std_str() { return m_str; }

        /// <summary>
        /// Returns a %reference to a standard STL string.
        /// </summary>
        /// <returns>Reference to a standard STL string.</returns>
        const stdstring_t& std_str() const { return m_str; }
        ...
        reference operator[](size_type n) { return m_str[n]; }
        
        /// <summary>Returns the n'th character.</summary>
        /// <param name='n'>Zero-based index of a character to return.</param>
        /// <returns>The n'th character.</returns>
        const_reference operator[](size_type n) const { return m_str[n]; }
