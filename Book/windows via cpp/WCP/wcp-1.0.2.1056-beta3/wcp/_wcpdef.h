#ifdef ____WCPDEF_H_CYCLE__
#error Cyclic dependency discovered: _wcpdef.h
#endif

#ifndef ___WCPDEF_H__


#ifndef DOXYGEN

#define ___WCPDEF_H__
#define ___WCPDEF_H_CYCLE__
...
/** \file
    The file contains basic global WCP library definitions.

    To use this file include wcp/wcplib.h.
*/


#if !defined(WCP_NS) || defined(DOXYGEN)
...
/// <summary>
/// WCP high version number.
/// </summary>
#define WCP_VERSION_HIGH    1

/// <summary>
/// WCP low version number.
/// </summary>
#define WCP_VERSION_LOW     0


/// <summary>
/// WCP version number.
/// </summary>
#define WCP_VERSION MAKELONG(WCP_VERSION_HIGH, WCP_VERSION_LOW)


/// <summary>
/// WCP ANSI string version number.
/// </summary>
#define WCP_VERSION_STR TOSTR(WCP_VERSION_HIGH) "." TOSTR(WCP_VERSION_LOW)

/// <summary>
/// WCP Unicode string version number.
/// </summary>
#define WCP_VERSION_STRW STRTOWSTR(WCP_VERSION_STR)


#ifndef WCP_SYNC_DELAY

/// <summary>
/// Defines a default delay (in milliseconds) of major synchronization actions.
/// Too low number may cause extra CPU time consuming for idle threads, and too high number
/// may cause idle threads to respond slower.
/// </summary>
#define WCP_SYNC_DELAY  10

#endif /*WCP_SYNC_DELAY*/
